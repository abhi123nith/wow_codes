                            ...
                            child: TabBar(
                              ...
                              tabs: [
                                ...allData['categories']
                                  ...
                                  return tabBarItem(() {
                                    changeSelected(c);
                                  }, e, Colors.black, Colors.white, 30,
                                      _tabController.index == c); // selected
                                }), // not selected
                              ],
                            ),
                          ),
...
class tabBarItem extends StatelessWidget {
  ...
  tabBarItem(
      this.callback, this.data, this.main, this.text, this.r, this.isSelected);
